          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar2"
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav align-items-center justify-content-end align-items-center flex-grow-1 ">
                ...
                <li class="nav-item">
                  <a class="btn-medium btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2">Sign
                    Up</a>
                </li>
  ...
  <section id="billboard">
    <div id="briketCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
      ...
      <div class="carousel-indicators">
        <button type="button" data-bs-target="#briketCarousel" data-bs-slide-to="0" class="active" aria-current="true"
          aria-label="Slide 1"></button>
        <button type="button" data-bs-target="#briketCarousel" data-bs-slide-to="1" aria-label="Slide 2"></button>
        <button type="button" data-bs-target="#briketCarousel" data-bs-slide-to="2" aria-label="Slide 3"></button>
      </div>
      ...
      <div class="carousel-inner" style="height: 700px;">
            ...
            <div class="row flex-lg-row-reverse align-items-center">
              <div class="col-lg-6">
                <img src="https://rumahsabut.com/wp-content/uploads/2024/07/arang-batok-kelapa.jpg"
                  class="d-block mx-lg-auto img-fluid" alt="Briket Ramah Lingkungan" width="700" height="500"
                  loading="lazy">
              </div>
              <div class="col-lg-6">
                <h1 class="text-capitalize lh-1 my-3">Briket Berkualitas, Harga Terjangkau</h1>
                <p class="lead">Beli atau jual briket dengan mudah. Cocok untuk rumah tangga, UMKM, hingga industri.
                  Hemat biaya dan ramah lingkungan.</p>
                <div class="d-flex gap-2 flex-wrap">
                  <!-- <select class="form-select" aria-label="Jenis Transaksi">
                  ...
                  <button class="btn btn-success">Cari Briket</button> -->
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="carousel-item" style="margin-top: 200px;">
          <div class="container my-5 text-center">
            <img src="#" class="img-fluid mb-4" alt="Briket Hemat Energi" width="700" height="400" loading="lazy">
            <h1 class="text-capitalize lh-1 mb-3">Solusi Energi Alternatif Terbaik</h1>
            <p class="lead mb-4">Kami menyediakan briket berkualitas tinggi untuk kebutuhan rumah tangga dan industri.
              Mudah digunakan, ekonomis, dan ramah lingkungan.</p>
        ...
        <div class="carousel-item">
          <div class="container my-5">
            <div class="row align-items-center">
              <div class="col-lg-6">
                <h1 class="text-capitalize lh-1 my-3">Dapatkan Briket Ramah Lingkungan Sekarang</h1>
                <p class="lead">Briket kami dibuat dari bahan alami, bebas bahan kimia berbahaya, dan efisien untuk
                  pemanasan atau memasak.</p>
                <!-- <form class="row g-2">
                  <div class="col-md-4">
                    <select class="form-select" aria-label="Transaksi">
                      <option selected>Transaksi</option>
                      <option value="1">Beli</option>
                      <option value="2">Jual</option>
                    </select>
                  ...
                  <div class="col-md-4">
                    <button type="submit" class="btn btn-warning w-100">Cari Sekarang</button>
                  </div>
                </form> -->
              </div>
              <div class="col-lg-6">
                <img src="https://rumahsabut.com/wp-content/uploads/2024/07/arang-batok-kelapa.jpg" class="img-fluid"
                  alt="Briket Eco Friendly" width="700" height="500" loading="lazy">
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- Controls -->
      <button class="carousel-control-prev" type="button" data-bs-target="#briketCarousel" data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Sebelumnya</span>
      </button>
      <button class="carousel-control-next" type="button" data-bs-target="#briketCarousel" data-bs-slide="next">
        ...
        <div class="row align-items-md-center">
          ...
          <div class="col-md-6 mb-1  mb-md-0">
            <div class="h-100 p-5 text-bg-dark rounded-3">
              <h4>About Us</h4>
              <p>
                Kami adalah penyedia briket ramah lingkungan yang berkomitmen pada solusi energi berkelanjutan untuk
                rumah tangga, bisnis, dan industri.
                Dengan kualitas terbaik dan harga bersaing, kami siap menjadi mitra terpercaya dalam memenuhi
        ...
        <div class="modal-content bg-dark text-white">
          ...
          <div class="modal-body text-center">
            ...
            <ul class="list-unstyled d-flex justify-content-center gap-3">
              <li><img src="images/bed.png" alt="bed" style="width: 16px;"> <span id="modalBed"></span> bed</li>
              <li><img src="images/bath.png" alt="bath" style="width: 16px;"> <span id="modalBath"></span> bath</li>
              <li><img src="images/square.png" alt="size" style="width: 16px;"> <span id="modalSize"></span> Sqft</li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="swiper-slide">
            <div class="card" data-bs-toggle="modal" data-bs-target="#ModalProduct">
              ...
              <div class="card-body p-0">
                ...
                <p class="card-text">Dibuat dari limbah serbuk kayu. Cocok untuk BBQ dan pemanas rumah tangga.</p>
                <div class="card-text">
                  <ul class="d-flex">
                    <li class="residence-list"><img src="images/weight.png" alt="image"> 5 Kg</li>
                    <li class="residence-list"><img src="images/heat.png" alt="image"> 6500 kcal/kg</li>
                    <li class="residence-list"><img src="images/type.png" alt="image"> Briket Kayu</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="card-body p-0">
                ...
                <div class="card-text">
                  <ul class="d-flex">
                    ...
                    <li class="residence-list"><img src="images/heat.png" alt="image"> 7200 kcal/kg</li>
                    <li class="residence-list"><img src="images/type.png" alt="image"> Briket Kelapa</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="swiper-slide">
            <div class="card">
              ...
              <div class="card-body p-0">
                ...
                <p class="card-text">Eco-friendly, ringan, dan mudah terbakar. Ideal untuk industri kecil.</p>
                <div class="card-text">
                  <ul class="d-flex">
                    <li class="residence-list"><img src="images/weight.png" alt="image"> 2.5 Kg</li>
                    <li class="residence-list"><img src="images/heat.png" alt="image"> 6000 kcal/kg</li>
                    <li class="residence-list"><img src="images/type.png" alt="image"> Briket Bambu</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="swiper-slide">
            <div class="card">
              ...
              <div class="card-body p-0">
                ...
                <p class="card-text">Alternatif murah dan efisien untuk rumah tangga dan pengeringan hasil panen.</p>
                <div class="card-text">
                  <ul class="d-flex">
                    <li class="residence-list"><img src="images/weight.png" alt="image"> 3 Kg</li>
                    <li class="residence-list"><img src="images/heat.png" alt="image"> 5500 kcal/kg</li>
                    <li class="residence-list"><img src="images/type.png" alt="image"> Briket Sekam</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="swiper-slide">
            <div class="card">
              ...
              <div class="card-body p-0">
                ...
                <p class="card-text">Gabungan bahan bakar ramah lingkungan untuk kebutuhan energi skala besar.</p>
                <div class="card-text">
                  <ul class="d-flex">
                    <li class="residence-list"><img src="images/weight.png" alt="image"> 10 Kg</li>
                    <li class="residence-list"><img src="images/heat.png" alt="image"> 6800 kcal/kg</li>
                    <li class="residence-list"><img src="images/type.png" alt="image"> Briket Biomassa</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="swiper-slide">
            <div class="row my-5 py-lg-5">
              <div class="col-md-8 mx-auto">
                ...
                <p class="testimonial-p mt-4">Massa semper non rutrum orci facilisi sit. Lectus porta quam a
                  fringilla
      ...
      <div class="row d-flex justify-content-between align-items-center">
        ...
        <div class="col-md-6">
          <div class="text-content ps-md-5 mt-4 mt-md-0">
            ...
            <p>
              Temukan berbagai jenis briket berkualitas yang kami produksi dari bahan alami seperti tempurung
              kelapa, serbuk gergaji, sekam padi, dan arang kayu. Briket kami dirancang untuk memenuhi kebutuhan
    ...
    <div class="container my-5 py-5">
      <div class="row featurette py-lg-5 ">
        ...
        <div class="col-md-7 order-md-2">
          <div class="text-content ps-md-5 mt-4 mt-md-0">
            <p class="py-lg-2">
              Briket adalah solusi hemat dan ramah lingkungan untuk kebutuhan memasak dan industri. Kami menyediakan
              beragam jenis briket dari bahan alami, seperti tempurung kelapa, serbuk kayu, dan sekam padi—tanpa bahan
        ...
        <div class="tabs-listing mt-4">
          <nav>
            <div class="nav nav-tabs d-flex justify-content-center border-0" id="nav-tab2" role="tablist">
              <button class="btn btn-outline-primary text-uppercase me-4 " id="nav-sign-in-tab2" data-bs-toggle="tab"
                data-bs-target="#nav-sign-in2" type="button" role="tab" aria-controls="nav-sign-in2"
                aria-selected="false">Log In</button>
              <button class="btn btn-outline-primary text-uppercase active" id="nav-register-tab2" data-bs-toggle="tab"
                data-bs-target="#nav-register2" type="button" role="tab" aria-controls="nav-register2"
            ...
            <div class="tab-pane fade " id="nav-sign-in2" role="tabpanel" aria-labelledby="nav-sign-in-tab2">
              <form id="form3" class="form-group flex-wrap p-3 ">
                ...
                <div class="form-input col-lg-12 my-4">
                  ...
                  <input type="password" id="inputPassword3" placeholder="Password" class="form-control ps-3"
              ...
              <form id="form4" class="form-group flex-wrap p-3 ">
                ...
                <div class="form-input col-lg-12 my-4">
                  <label for="inputPassword4"
                    class="form-label  fs-6 text-uppercase fw-bold text-black">Password</label>
                  <input type="password" id="inputPassword4" placeholder="Password" class="form-control ps-3"
                    aria-describedby="passwordHelpBlock">
                </div>
                <label class="py-3">
                  <input type="checkbox" required="" class="d-inline">
